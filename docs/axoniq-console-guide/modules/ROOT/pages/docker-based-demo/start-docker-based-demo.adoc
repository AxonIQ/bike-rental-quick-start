...
In the next step we will take a look at how xref::custom-app/your-app-in-axoniq-console.adoc[AxonIQ Console shows the information about your application's behaviour and performance].
